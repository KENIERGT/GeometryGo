...
const CUERPOS={};const CONFIG_DEFECTO = {
...
const fs=require("fs");
for(let i=0;i<GLIFOS.length;i++) fs.writeFileSync("data/patrones/p"+String(i).padStart(2,"0")+".patt", generarPatt(i));
console.log("regenerados",GLIFOS.length);
